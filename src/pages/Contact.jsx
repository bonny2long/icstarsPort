...
import { contactLinks, contactStrengths, profile } from "../data/profile";
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(320px,400px)] lg:items-center">
          <div>
            <SectionIntro
              ...
              titleAs="h1"
              subtitle={`${profile.shortBio} ${profile.longBio}`}
            />
      ...
      <Section>
        <div className="rounded-[2rem] border border-slate-200/80 bg-slate-950 p-8 text-white shadow-[0_28px_80px_-55px_rgba(15,23,42,0.6)] sm:p-10">
          <SectionIntro
            ...
            title="If you need a software engineer who can connect product workflows, data, backend systems, and clear delivery, I would like to hear about the work."
            titleClassName="text-white"
            subtitle="My current direction brings full-stack engineering, enterprise data and analytics development, and applied AI workflows together."
