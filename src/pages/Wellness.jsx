  ...
  return (
    <PageWrapper>
      ...
      <Card title="Financial Wellness">
        <p className="mb-3">
          During i.c.stars, I learned that financial stability is part of being
          able to take risks and pursue big goals. I started treating money as a
          tool that supports my future instead of something that just reacts to
          the moment.
        </p>
      ...
      <Card title="Emotional Wellness">
        <p className="mb-3">
          One of the biggest shifts at i.c.stars was realizing how powerful my
          inner voice is. I created a daily alignment practice that starts my
          mornings with gratitude, intention, and belief in my ability to solve
          hard problems.
        </p>
      ...
      <Card title="Mental Wellness">
        <p className="mb-3">
          The intensity of the program taught me to pay attention to my mental
          energy. Between coding, deadlines, and presentations, I had to learn
          how to reset, refocus, and protect my momentum.
        </p>
        ...
        <p className="mt-3">
          These aren&apos;t just coping tools — they are performance tools that
          help me show up as a better developer and teammate.
        </p>
      </Card>
      ...
      <Card title="Physical Wellness">
        ...
        <p className="mt-3">
          Physical, emotional, mental, and financial wellness all connect back
          to how I work. They give me the stability, energy, and resilience to
          grow in tech and leadership long term.
        </p>
      </Card>
    </PageWrapper>
  );
